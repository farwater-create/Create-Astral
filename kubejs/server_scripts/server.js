...
function lizardMiscChanges(event) {
  ...
  event.replaceInput(
    { input: "techreborn:rubber", output: "techreborn:insulated_copper_cable" },
    "minecraft:copper_ingot",
    "createaddition:copper_rod"
  );
...
function lizardCH3Changes(event) {
  ...
  event.replaceInput(
    { type: "minecraft:crafting_shaped", output: "techreborn:chunk_loader" },
...
function lizardGrinderCrushingRework(event) {
  ...
  const GRINDER_RECIPES_TO_BECOME_CRUSHING = [
  ...
  const TECHREBORN_RANDOM_ORE_NEED_CRUSHING = [
    "sapphire",
    "bauxite",
    "cinnabar",
    "ruby",
  ...
  const TECHREBORN_RANDOM_ORE_NO_DEEPSLATE = [
    "pyrite",
    "cinnabar",
    "sphalerite",
  ];
...
function lizardGeologyAlchemyChanges(event) {
  ...
  event.recipes.createCrushing(
    ["minecraft:clay_ball", Item.of("minecraft:clay_ball").withChance(0.5)],
    "minecraft:dripstone_block"
  );
  ...
  event.recipes.createCrushing(
    [
      ...
      Item.of("techreborn:andesite_dust").withChance(0.5),
    ],
    "minecraft:andesite"
  );
  ...
  event.recipes.createCrushing(
    [
      "createastral:lime",
      Item.of("createastral:lime").withChance(0.5),
  ...
  event.recipes.createCrushing(
    [
      ...
      Item.of("techreborn:lazurite_dust").withChance(0.5),
      Item.of("techreborn:raw_tin").withChance(0.2),
      Item.of("techreborn:tin_nugget").withChance(0.3),
      Item.of("minecraft:clay_ball").withChance(0.2),
    ],
    "create:asurine"
  );
...
onEvent("recipes", (event) => {
  ...
  event.recipes
    .createMixing("1x techreborn:carbon_mesh", ["2x techreborn:carbon_fiber"])
    .superheated()
    .processingTime(400);
  ...
  event.recipes
    .createSequencedAssembly(
      ...
      Item.of("createastral:brass_helmet").ignoreNBT(),
      [
        // input
        event.recipes.createFilling("createastral:brass_helmet", [
          "createastral:brass_helmet",
          { fluid: "tconstruct:molten_diamond", amount: 20250 },
        ]), //fill 1/4 bucket lava
      ]
    )
    .transitionalItem("createastral:brass_helmet")
    .loops(4);
  ...
  event.recipes
    .createSequencedAssembly(
      ...
      Item.of("createastral:brass_chestplate").ignoreNBT(),
      [
        // input
        event.recipes.createFilling("createastral:brass_chestplate", [
          "createastral:brass_chestplate",
          { fluid: "tconstruct:molten_diamond", amount: 20250 },
        ]), //fill 1/4 bucket
      ]
    )
    .transitionalItem("createastral:brass_chestplate")
    .loops(8);
  ...
  event.recipes
    .createSequencedAssembly(
      ...
      Item.of("createastral:brass_leggings").ignoreNBT(),
      [
        // input
        event.recipes.createFilling("createastral:brass_leggings", [
          "createastral:brass_leggings",
          { fluid: "tconstruct:molten_diamond", amount: 20250 },
        ]), //fill 1/4 bucket
      ]
    )
    .transitionalItem("createastral:brass_leggings")
    .loops(6);
  ...
  event.recipes
    .createSequencedAssembly(
      ...
      Item.of("createastral:brass_boots").ignoreNBT(),
      [
        // input
        event.recipes.createFilling("createastral:brass_boots", [
          "createastral:brass_boots",
          { fluid: "tconstruct:molten_diamond", amount: 20250 },
        ]), //fill 1/4 bucket
      ]
    )
    .transitionalItem("createastral:brass_boots")
    .loops(5);
  ...
  event.recipes
    .createSequencedAssembly(
      ...
      Item.of("createastral:brass_pickaxe").ignoreNBT(),
      [
        // input
        event.recipes.createFilling("createastral:brass_pickaxe", [
          "createastral:brass_pickaxe",
          { fluid: "tconstruct:molten_diamond", amount: 20250 },
        ]), //fill 1/4 bucket
      ]
    )
    .transitionalItem("createastral:brass_pickaxe")
    .loops(2);
  ...
  event.recipes
    .createSequencedAssembly(
      ...
      Item.of("createastral:brass_axe").ignoreNBT(),
      [
        // input
        event.recipes.createFilling("createastral:brass_axe", [
          "createastral:brass_axe",
          { fluid: "tconstruct:molten_diamond", amount: 20250 },
        ]), //fill 1/4 bucket
      ]
    )
    .transitionalItem("createastral:brass_axe")
    .loops(2);
  ...
  event.recipes
    .createSequencedAssembly(
      ...
      Item.of("createastral:brass_shovel").ignoreNBT(),
      [
        // input
        event.recipes.createFilling("createastral:brass_shovel", [
          "createastral:brass_shovel",
          { fluid: "tconstruct:molten_diamond", amount: 20250 },
        ]), //fill 1/4 bucket
      ]
    )
    .transitionalItem("createastral:brass_shovel")
    .loops(1);
  ...
  event.recipes
    .createSequencedAssembly(
      ...
      Item.of("createastral:brass_sword").ignoreNBT(),
      [
        // input
        event.recipes.createFilling("createastral:brass_sword", [
          "createastral:brass_sword",
          { fluid: "tconstruct:molten_diamond", amount: 20250 },
        ]), //fill 1/4 bucket
      ]
    )
    .transitionalItem("createastral:brass_sword")
    .loops(2);
  ...
  event.recipes
    .createSequencedAssembly(
      ...
      Item.of("createastral:brass_hoe").ignoreNBT(),
      [
        // input
        event.recipes.createFilling("createastral:brass_hoe", [
          "createastral:brass_hoe",
          { fluid: "tconstruct:molten_diamond", amount: 20250 },
        ]), //fill 1/4 bucket
      ]
    )
    .transitionalItem("createastral:brass_hoe")
    .loops(1);
    ...
    .createSequencedAssembly(
      ...
      [
        event.recipes.createFilling("create:incomplete_precision_mechanism", [
          "create:incomplete_precision_mechanism",
          { fluid: "tconstruct:molten_cobalt", amount: 1350 },
        ]), //fill bronze
        event.recipes.createDeploying("create:incomplete_precision_mechanism", [
  ...
  event.recipes.createCrushing(["ad_astra:moon_sand"], "ad_astra:moon_stone");

  // event.recipes.createSplashing([
  //   Item.of('techreborn:silver_nugget').withChance(0.25),
  // ], 'ad_astra:moon_sand')

  event.recipes.createCrushing(["ad_astra:mars_sand"], "ad_astra:mars_stone");
  ...
  event.recipes
    .createSequencedAssembly(
      ...
      [
        // input
        event.recipes
          .createCutting("create:golden_sheet", "create:golden_sheet")
          .processingTime(30),
        ...
        event.recipes
          .createPressing("create:golden_sheet", "create:golden_sheet")
          .processingTime(75),
      ]
    )
    ...
    .createSequencedAssembly(
      ...
      [
        event.recipes
          ...
          .processingTime(75), //fill
        event.recipes
          .createPressing("ad_astra:iron_plate", "ad_astra:iron_plate")
          .processingTime(75),
      ]
    )
    ...
    .createSequencedAssembly(
      ...
      [
        event.recipes.createFilling("minecraft:cobbled_deepslate", [
          "minecraft:cobbled_deepslate",
          { fluid: "minecraft:lava", amount: 3000 },
        ]), //fill bronze
  ...
  event.recipes.createCrushing(
    [
      ...
      Item.of("minecraft:warped_fungus").withChance(0.15),
    ],
